...
use rustic_core::{BackupOptions, ConfigOptions, PruneOptions, repofile::SnapshotFile, JobCancelToken};
...
fn test_append_only(
    ...
    let snap = repo.backup(&opts, paths, SnapshotFile::default(), JobCancelToken::new())?;
